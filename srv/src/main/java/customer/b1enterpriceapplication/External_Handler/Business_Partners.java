...
@Component
@ServiceName("Business_Partner")
public class Business_Partners implements EventHandler {
    
    @Autowired
    public Login_session loginsession;

    @On(event = CqnService.EVENT_READ, entity = "Business_Partner.BusinessPartners")
    ...
    public void onReadBusinessPartners(CdsReadEventContext context) {
        ...
        // String nextUrl = b1Url + "/BusinessPartners?$top=20";
