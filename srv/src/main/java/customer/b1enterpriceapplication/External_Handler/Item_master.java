...
@Component
@ServiceName("Item_master")
public class Item_master implements EventHandler {
    
       @Autowired
    public Login_session loginsession;

    @On(event = CqnService.EVENT_READ, entity = "Item_master.Items")
    @SuppressWarnings("unchecked")
    public void onReadItem_Masters(CdsReadEventContext context) {
        ...
        String nextUrl = b1Url + "/Items?$top=20";
